package com.dataoct.onlineshop.security;
...
import com.dataoct.onlineshop.security.JWT.JwtEntryPoint;
import com.dataoct.onlineshop.security.JWT.JwtFilter;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception{
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/seller/product/new").access("hasAnyRole('MANAGER', EMPLOYEE)")
